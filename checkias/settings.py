"""
Django settings for checkias project.
...
SECRET_KEY = 'django-insecure-lq*vq55#bra1^m7#vrfss&3gx+9!+ft9oqjwjdq(pfwswghnw('
...
WSGI_APPLICATION = 'checkias.wsgi.application'
